...
def experiment_db(config_file, opt_action):
    ...
    G_gallus = '%s/G_gallus/ensembl_release_79/ensembl_release_79.fas.bz2' % data_path,
    ...
    G_gallus = '%s/G_gallus/ensembl_release_79/ensembl_release_79.gtf.bz2' % data_path,
