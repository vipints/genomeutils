...
def fetch_ensembl_protists_gtf(release_version, species_name, download_path):
    ## check the url for getting the recent version of the repository 
    base_url_gtf = "ftp://ftp.ensemblgenomes.org/pub/protists/release-%s/gtf/" % release_version 
...
def fetch_ensembl_protists_fasta(release_version, species_name, download_path):
    ## check the url for getting the recent version of the repository 
    base_url_fasta = "ftp://ftp.ensemblgenomes.org/pub/protists/release-%s/fasta/" % release_version 
    ...
    for org_name in org_file:
        ...
        try:
            ...
            exit("ensembl_protists_release genome sequence missing" % base_url_fasta)
