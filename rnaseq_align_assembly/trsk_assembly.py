#!/usr/bin/env python 
"""
Program to run transcriptome assembly using TransriptSkimmer on read alignment data 
...
def run_trsk(org_name, gio_file, bam_file, res_path, gff_file="pred_genes.gff", reg_file="pred_region.bed"):
    ...
    max_exon_length = org_db
    max_intron_length = org_db
    max_intergenic_region = org_db
