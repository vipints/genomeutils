...
Usage: python trsk_pred_filter.py in.gff in.fasta > filter.gff 
"""
...
def check_pred_genes(gff_name, fas_file):
    """
    check the sequence consistency/quality of predicted fragment

    TODO: this function has to integrate with trsk codebase
...
if __name__ == "__main__":
    ...
    check_pred_genes(gff_name, fas_file)
